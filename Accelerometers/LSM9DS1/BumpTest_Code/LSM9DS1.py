...
LSM9DS1v2a_MAG_ADDRESS	= 0x1C	#Would be 0x1E if SDO_M is HIGH		
LSM9DS1v2a_ACC_ADDRESS	= 0x6A  
LSM9DS1v2a_GYR_ADDRESS = 0x6A  #Would be 0x6B if SDO_AG is HIGH

LSM9DS1v2b_MAG_ADDRESS	= 0x1E	#Would be 0x1E if SDO_M is HIGH		
LSM9DS1v2b_ACC_ADDRESS	= 0x6B  
LSM9DS1v2b_GYR_ADDRESS = 0x6B  #Would be 0x6B if SDO_AG is HIGH
