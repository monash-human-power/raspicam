...
const int freqMax = 1000;  // maximal allowed cmdline arg sampling rate of data stream, Hz
...
const double accConversion = 2 * 100.0 / 65536.0;  // +/- 16g range, 13-bit resolution
const double tStatusReport = 1;  // time period of status report if data read to file, seconds

void printUsage() {
    printf( "H3LIS331DLspi (version %s) \n"
            "License GPLv3+: GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>\n"
            "\n"
            "Usage: H3LIS331DLspi [OPTION]... \n"
            "Read data from H3LIS331DL accelerometer through SPI interface on Raspberry Pi.\n"
            "Online help, docs & bug reports: <https://github.com/nagimov/H3LIS331DLspi/>\n"
            "\n"
