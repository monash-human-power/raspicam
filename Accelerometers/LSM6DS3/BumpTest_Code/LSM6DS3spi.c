...
#define DATA_FORMAT_B 0x0B  // data format bytes: +/- 16g range, 13-bit resolution (p. 26 of lsm6ds3 datasheet)
#define READ_BIT      0x80
#define MULTI_BIT     0x00
...
const double accConversion = 2 * 16.0 / 65536.0;  // +/- 16g range, 13-bit resolution
const double tStatusReport = 1;  // time period of status report if data read to file, seconds

void printUsage() {
    printf( "lsm6ds3spi (version %s) \n"
            "License GPLv3+: GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>\n"
            "\n"
            "Usage: lsm6ds3spi [OPTION]... \n"
            "Read data from lsm6ds3 accelerometer through SPI interface on Raspberry Pi.\n"
            "Online help, docs & bug reports: <https://github.com/nagimov/lsm6ds3spi/>\n"
            "\n"
